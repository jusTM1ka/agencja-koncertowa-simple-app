import GUI.DbController;
import GUI.MyFrame;
import Models.WlascicielAgencji;
import Models.WlascicielObiektu;
...
public class Client {
    ...
    public Client(){
        try {
            ...
            session.close();
            DbController dbController = new DbController(sessionFactory);
            myFrame = new MyFrame(dbController);
            ...
            if (sessionFactory != null && !myFrame.isActive()) {
